...
Une analyse complète des performances du modèle (prédictions, résidus, interprétation du signal et limites) est disponible dans [MODEL_RESULTS.md](MODEL_RESULTS.md).
